  ...
  useEffect(() => {
    const fetchData =  () => {
      try {
        ...
        const gbmSimulations = runSimulations(startPrice, days, mu, sigma, dt, numSimulations, geometricBrownianMotion);

        setSimulations([
          { name: 'Geometric Brownian Motion', data: gbmSimulations },
        ]);
