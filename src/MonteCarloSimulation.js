    ...
    <div>
      ...
      <form onSubmit={(event) => runSimulation(event)}>
        <label>
          ...
          <input type="number" value={startPrice} onChange={(e) => setStartPrice(parseFloat(e.target.value))} />
        </label>
        <br />
        <label>
          Days of Simulation:
        ...
        <label>
          Mu:
          <input type="number" value={mu} onChange={(e) => setMu(parseFloat(e.target.value))} />
        </label>
        <br />
        <label>
          Sigma:
          <input type="number" value={sigma} onChange={(e) => setSigma(parseFloat(e.target.value))} />
        </label>
        <br />
      ...
      <div>
        {simulationData.length > 0 && (
          <Plot
            ...
            layout={{ title: 'Monte Carlo Simulation for TD', width: 1000, height: 400, xaxis: { title: 'Days' }, yaxis: { title: 'Price' } }}
          />
        )}
      </div>
    </div>
